...
Créer un nouvelle branche `02-branch/feat/velo` en partant de `02-branch/main`
...
Créer un commit `feat: fix prenom in contact.yaml`.
...
Placer vous sur la branche `02-branch/feat/velo` avec `git switch 02-branch/feat/velo`
...
Placer vous sur la branche `02-branch/main` avec `git switch 02-branch/main`
